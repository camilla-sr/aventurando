...
public class TracoStrategy implements FormularioStrategy{
	@Override public String getTipoComponente() { return "tracos"; }
	@Override public Object getEntidadeVazia() { return new TracoPersonalidade(); }
	@Override public String getEndpoint() {return "/traco-api"; }
}