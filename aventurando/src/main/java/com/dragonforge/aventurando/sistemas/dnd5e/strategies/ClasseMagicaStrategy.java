...
public class ClasseMagicaStrategy implements FormularioStrategy{
	@Override public String getTipoComponente() { return "classe_magica"; }
	@Override public Object getEntidadeVazia() { return new ClasseMagica(); }
	@Override public String getEndpoint() {return "/classemagica-api"; }
}