...
public class DefeitoStrategy implements FormularioStrategy{
	@Override public String getTipoComponente() { return "defeitos"; }
	@Override public Object getEntidadeVazia() { return new Defeito(); }
	@Override public String getEndpoint() {return "/defeito-api"; }
}