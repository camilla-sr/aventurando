...
public class JogadorStrategy implements FormularioStrategy{
	@Override public String getTipoComponente() { return "jogador"; }
	@Override public Object getEntidadeVazia() { return new Jogador(); }
	@Override public String getEndpoint() {return "/jogador-api"; }
}