...
public class AntecedenteStrategy implements FormularioStrategy{
	@Override public String getTipoComponente() { return "antecedentes"; }
	@Override public Object getEntidadeVazia() { return new Antecedente(); }
	@Override public String getEndpoint() {return "/antecedente-api"; }
}
