...
public class TendenciaStrategy implements FormularioStrategy{
	@Override public String getTipoComponente() { return "tendencias"; }
	@Override public Object getEntidadeVazia() { return new Tendencia(); }
	@Override public String getEndpoint() {return "/tendencia-api"; }
}